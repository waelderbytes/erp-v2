...
@Module({
  imports: [
    TypeOrmModule.forFeature([Artikel, ArtikelUebersetzung, ArtikelLieferant, Artikelkategorie, ArtikelkategorieZuordnung, Lagerbewegung]),
    PassportModule,
    FirmaModule,
    NummernkreisModule,
  ],
  controllers: [ArtikelController],
  providers: [ArtikelService, ArtikelNummerService, ArtikelLogService, JwtStrategy],
})
