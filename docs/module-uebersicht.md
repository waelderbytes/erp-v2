...
| Modul | Status | Beschreibung |
|---|---|---|
| Artikelstamm | ⬜ offen | inkl. Gruppen-/Untergruppen-Hierarchie, Nummernschema XXX-YYY-lfd, Artikelart (Handelsware/Dienstleistung/Fertigungsartikel), Variantenartikel (z. B. Farbe/Größe/Ausführung als verknüpfte Artikel-Varianten mit gemeinsamer Basis) |
